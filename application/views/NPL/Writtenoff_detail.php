            ...
            <div class="">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="x_panel">
                    <div class="x_title">
                    <span class="glyphicon glyphicon-align-justify"></span><span style="margin-left:10px;">របាយការណ៍ប្រាក់ប្រមូលបានពីអតិថិជនកាត់ចេញពីបញ្ជីរបង់ចូល SKP_Tools</span>
                            ...
                            <table class="table table-bordered projects" id="datatable-buttons">
                                ...
                                $i=1;
                                  ...
                                  <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:right;"><?= number_format($row->TotalCollectedAmt,0);$Total+=$row->TotalCollectedAmt;?></td>
