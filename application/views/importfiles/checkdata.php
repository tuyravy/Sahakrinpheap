...
<div class="[ container text-center ]">
    <div class="[ row ]">
        <div class="[ col-xs-12 ]" style="padding-bottom: 30px;">
            <p>Please close your system and then you can view reports</p>
        </div>
    </div>
</div>
<div class="[ container text-center ]">
                ...
                <div class="tab-content" id="tabs-collapse">            
                    <div role="tabpanel" class="tab-pane fade in active" id="dustin">
                        <div class="tab-inner">                    
                             ...
                             <div class="container">
                                <div class="row">
                                    <h3>Please close your system and then you can view reports <br /><small></small></h3>
                                    <p><strong>END OFF MONTH</strong></p>
                                    <form action="<?php echo site_url('eomsystem');?>" method="post">
