            ...
            <div class="">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="x_panel">
                    <div class="x_title">
                    <span class="glyphicon glyphicon-align-justify"></span><span style="margin-left:10px;">CASH IN FLOW</span>
                      ...
                      <div id="reports">
                        <div class="row" id="logoreports" style="display:none">
                                ...
                                <div class="col-md-6" id="textcenter">
                                    ...
                                    <h2 id="in2" style="text-align:center;">Cash In Flow Reports</h2>
                        ...
                        <table class="table table-bordered projects" id="datatable-buttons">
                          <thead>
                            <tr style="border-bottom:3pt solid #22d4ae;">
                              ...
                              <th style="text-align:center;white-space: nowrap;overflow: hidden;">Loan Prepayment</th>
                              ...
                              <!-- <th style="white-space: nowrap;overflow: hidden;text-align:center">Ending Balance</th> -->
                            </tr>
                          </thead>
