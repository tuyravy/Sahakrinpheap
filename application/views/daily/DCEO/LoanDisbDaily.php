                ...
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    <li>
                     ...
                     <li class="active"><a href="<?= site_url('dailydceo/loanDisbDaily');?>">
                        ...
                        <div id="home" class="tab-pane fade in active">
                         ...
                         <div class="row nopadding">
                          <div class="col-md-12 nopadding">
                                  <form class="form-inline" action="<?php echo site_url('dailydceo/loanDisbDaily');?>" method="POST">
        ...
        <script src="<?php echo base_url();?>/public/DCEO/loandisbDaily.js"></script> 
