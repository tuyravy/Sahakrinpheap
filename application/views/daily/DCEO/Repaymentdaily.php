               ...
               <div class="dashboard_graph x_panel">
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?= site_url('dailydceo/repaymentdaily');?>">
                           ...
                           <br/>
                            <div class="row nopadding">
                             <div class="col-md-12 nopadding">
                                <form class="form-inline" action="<?php echo site_url('dailydceo/repaymentdaily');?>" method="POST">
        ...
        <script src="<?php echo base_url();?>/public/DCEO/repaymentdaily.js"></script> 
        <script>
