               ...
               <div class="dashboard_graph x_panel">
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="<?= site_url('dailydceo/repaymentinmonth');?>">
                           ...
                           <br/>
                            <div class="row nopadding">
                             <div class="col-md-12 nopadding">
                                <form class="form-inline" action="<?php echo site_url('dailydceo/repaymentinmonth');?>" method="POST">
                        ...
                        <table id="datatable-buttons5" class="table table-bordered">
                          <thead>
                            <tr style="text-align:center;boder;">
                              <th style="boder;border-bottom:3pt solid #22d4ae;text-align:center;padding:10px 0px 25px 0px;white-space: nowrap;overflow: hidden;" rowspan="2">BrName</th>
                              <th style="boder;border-bottom:3pt solid #22d4ae;text-align:center;padding:10px 0px 25px 0px;white-space: nowrap;overflow: hidden;" rowspan="2">BrCode</th>
        ...
        <script src="<?php echo base_url();?>/public/DCEO/repaymentinmonth.js"></script> 
        <script>
