               ...
               <div class="dashboard_graph x_panel">
                <div class="container">                  
                  ...
                  <li class="active">
                     ...
                     <li><a href="<?= site_url('dailyrm/loanDisbDaily');?>">
                        ...
                        <div id="home" class="tab-pane fade in active">
                         ...
                         <div class="row nopadding">
                          <div class="col-md-12 nopadding">
                                  <form class="form-inline" action="<?php echo site_url('dailyrm/loanDisbInMonth');?>" method="POST">
        ...
        <script src="<?php echo base_url();?>/public/RM/loandisb.js"></script>  
        <script>
