               ...
               <div class="dashboard_graph x_panel">
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?= site_url('dailyrm/PortfolioQualitybyProductDaily');?>">
                        <span class="glyphicon glyphicon-th-list"></span>
                        <span style="margin-left:5px;"></span>
                        ...
                        <div id="home" class="tab-pane fade in active">
                           <br/>
                            <div class="row nopadding">
                             ...
                             <form class="form-inline" action="<?php echo site_url('dailyrm/PortfolioQualitybyProductDaily');?>" method="POST">
        ...
        <script src="<?php echo base_url();?>/public/RM/portfolioqbyproduct.js"></script> 
