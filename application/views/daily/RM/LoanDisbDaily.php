        ...
        <div class="breadcrumb flat row nopadding" style="margin-top:-10px;">
                        ...
                        <a href="<?= site_url('dailyrm/loanDisbInMonth');?>" class="active">Loan Disbursement</a>
               ...
               <div class="dashboard_graph x_panel">
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    <li>
                        <a href="<?= site_url('dailyrm/loanDisbInMonth');?>">
                        <span class="glyphicon glyphicon-home"></span>
                       <span style="margin-left:5px;"></span>Loans disbursement in Month</a></li>
                                    
                     <li class="active"><a href="<?= site_url('dailyrm/loanDisbDaily');?>">
                        ...
                        <div id="home" class="tab-pane fade in active">
                         ...
                         <div class="row nopadding">
                          <div class="col-md-12 nopadding">
                                  <form class="form-inline" action="<?php echo site_url('dailyrm/loanDisbDaily');?>" method="POST">
                        ...
                        <table id="datatable-buttons2" class="table table-striped table-bordered">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td style="text-align:right"><?= $re->DisbAmtDaily;$totalDisb+=$re->DisbAmtDaily;?></td>
                                  <td><?= $re->PrName;?></td>
                              ...
                              <tr>
                               ...
                               <td style="text-align:right"><?= $totalDisb;?></td>
                               <td colspan="3"></td>
        ...
        <script src="<?php echo base_url();?>/public/RM/loandisbDaily.js"></script> 
