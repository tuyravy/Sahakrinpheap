                        ...
                        <table class="table table-bordered table-condensed f11">
                            ...
                            <?php $i=1;
                               ...
                               <tr style="text-align:right;white-space: nowrap;overflow: hidden;">
                                        ...
                                        <td>
                                        <?php  
                                            if($row->PAR1Days==0 || $row->Balance==0){ $PAR1Days=1;echo number_format(0,2);}else if($row->Balance==0){$Balance=1;echo number_format($PAR1Days/$Balance*100,2);}
                                            else{
                                        ...
                                        <td><?php
                                            if($row->PAR1Days_pre==0 || $row->Balance_pre==0){echo 0;}else{
                                ...
                                <tr style="text-align:right;white-space: nowrap;overflow: hidden;" class="active">
                                        ...
                                        <td><?php
                                            if($TotalPar1Days==0 || $TotalBalance==0){
                                                echo 0;
                                            }else{
                                            echo number_format(($TotalPar1Days/$TotalBalance)*100,2);
                                            }?>%</td>
