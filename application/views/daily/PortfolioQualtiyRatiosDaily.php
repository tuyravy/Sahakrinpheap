                ...
                <div class="container">                  
                  <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?= site_url('daily/PortfolioQualitybyProductDaily');?>">
                        ...
                        <li class="active"><a href="<?= site_url('daily/PortfolioQualtiyRationsDaily');?>">
                        <span class="glyphicon glyphicon-th-list"></span>
                        <span style="margin-left:5px;"></span>
                        ...
                        <div id="home" class="tab-pane fade in active">
                           <br/>
                            <div class="row nopadding">
                             ...
                             <form class="form-inline" action="<?php echo site_url('daily/PortfolioQualtiyRationsDaily');?>" method="POST">
        ...
        <script src="<?php echo base_url();?>/public/BM/portfolioqRatiosDaily.js"></script> 
        <script>
