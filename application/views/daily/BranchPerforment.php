                          ...
                          <thead>
                           ...
                           <?php $i=1;
                               ...
                               <tr style="text-align:right;white-space: nowrap;overflow: hidden;" class="active">
                                        ...
                                        <td style="text-align:right"><?php if($PAR1_Amt==0 ||$PAR1_Amt_P==0){$PAR1_Amt=1;$PAR1_Amt_P=1; echo number_format(($PAR1_Amt/$OS-$PAR1_Amt_P/$OS_P)*100,2);}else{echo number_format(($PAR1_Amt/$OS-$PAR1_Amt_P/$OS_P)*100,2);?>%</td>
