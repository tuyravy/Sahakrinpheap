      ...
      <div class="breadcrumb flat row nopadding" style="margin-top:-10px;">
                        ...
                        <a href="<?= site_url('daily/loanPortfolio');?>" class="active">Loan Portfolio</a>
                    ...
                    <div class="demo-container" style="height:auto">
                         <div class="row nopadding">
                          <div class="col-md-12 nopadding">
                                  <form class="form-inline" action="<?php echo site_url('daily/loanPortfolio');?>" method="POST">
...
<script src="<?php echo base_url();?>/public/BM/loanportfolio.js"></script>   
<script>
