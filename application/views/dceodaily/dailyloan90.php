...
?><!-- page content -->
        ...
        <script src="<?php echo base_url();?>public/vendors/jquery/dist/jquery.min.js"></script>
            ...
            <div class="breadcrumb flat row nopadding" style="margin-top:-10px;">
                        ...
                        <a href="<?= site_url('daily/daillyloan');?>" class="active">Written-Off and Loan > 90 Days</a>
                  ...
                  <div class="x_content">
                    <div class="demo-container" style="height:auto;">
                      ...
                      <div class="col-md-12 nopadding">
                       ...
                       <div class="panel-body table-responsive" style='margin-left:-15px;'>
                          ...
                          <tr class="active">
                           ...
                           <tbody>
                               ...
                               <?php }?>
                                   ...
                                   <?php 
                                            $grandtoal=$this->DailyCmr_model->getGrandTotalAll(1,$reportdate,0,0);
                                    ...
                                    <td><?= number_format($row->Collection/$row->Balance,2);?></td>
                                    <td style="text-align:center">Total:</td>
