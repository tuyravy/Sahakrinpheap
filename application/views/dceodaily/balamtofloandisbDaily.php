                ...
                <div class="container">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?php echo site_url("daily/numberofloandisbdaily");?>">
                     ...
                     <li class="active"><a data-toggle="tab" href="<?php echo site_url("daily/balamtofloandisbdaily");?>">
                        <span class="glyphicon glyphicon-th-list"></span>
                        <span style="margin-left:5px;"></span>
                        ...
                        <div id="reports">
                          ...
                          <thead>
                            <tr>
                             ...
                             <tbody id="showvaluesdaily">  
                                <?php 
                                   
                                    $page = $this->uri->segment(2) ? $this->uri->segment(3):1;
                                    $active=$this->DailyCmr_model->getValueofDailyLoansdisbursementinDCEO($page,$reportdate,$type);
                                    $sumAcc=0;
                                    $ILD=0;
                                    $ILF=0;
                                    $GLD=0;
                            ...
                            <tr style="text-align:right">
                              <td style="text-align:center"> <?php echo $row->shortcode;?>                              
                                      ...
                                      <td><?php echo $row->Balance;$sumAcc+=$row->Balance;?></td>
                              ...
                              <?php }?>
                                ...
                                <tr style="text-align:right">
                                 ...
                                 <?php $grandtotal=$this->DailyCmr_model->getGrandTotalLoanDisbursement(4,$reportdate);
