               ...
               <div class="dashboard_graph x_panel">
                <div class="container">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="<?php echo site_url("daily/loanDisbd");?>">
                    ...
                    <li><a href="<?php echo site_url("daily/numberofloandisbdaily");?>">
                     ...
                     <li><a data-toggle="tab" href="<?php echo site_url("daily/balamtofloandisbdaily");?>">
                        <span class="glyphicon glyphicon-th-list"></span>
                        <span style="margin-left:5px;"></span>
                        ...
                        <table id="datatable-buttons2" class="table table-striped table-bordered">
                          ...
                          <tbody>
                             <?php
                                    ...
                                    $reportdate=date("Y-m-d",strtotime($this->Menu_model->getCurrRundate()));                                    
                                    $active=$this->DailyCmr_model->getLoansdisbursementInMonthDCEO(10,$page,$reportdate,$type);
                                    $sumAcc=0;
                                    $ILD=0;
                                    $ILF=0;
                                    $GLD=0;
                            ...
                            <?php $grandtotal=$this->DailyCmr_model->getGrandTotalLoanDisbursement(1,$reportdate);
