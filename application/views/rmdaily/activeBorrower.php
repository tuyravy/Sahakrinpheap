...
?><!-- page content -->
        ...
        <script src="<?php echo base_url();?>public/vendors/jquery/dist/jquery.min.js"></script>
            ...
            <div class="breadcrumb flat row nopadding" style="margin-top:-10px;">
                        ...
                        <a href="<?= site_url('active');?>" class="active">Loan Active Borrower</a>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="dashboard_graph x_panel">
                  ...
                  <div class="row x_title">
                    <div class="col-md-6">
                      <h3>Active Borrower <span style="margin-left:10px;"></span><small>By Branch</small></h3>
                    </div>
                             ...
                             <div class="col-md-10 nopadding">
                                  ...
                                  <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">Specific Period:</legend>
                                      <div class="form-group">                                       
                                          ...
                                          <input type="text" id="datestart1" class="form-control" name="datestart" id="exampleInputName2"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail2">To:</label>
                                        <input type="text" class="form-control" id="dateend1" name="dateend" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-start-date="+2d" 
                              ...
                              <button type="submit" class="btn btn-primary" id="dailyloandisb" style="margin-top:5px;">Search</button>
                              </fieldset>
                            </form>
                          </div>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                          ...
                          <tbody id="myTable">
                             <?php 
                                    ...
                                    $reportdate=date("Ymd",strtotime($this->Menu_model->getCurrRundate()));                                    
                                    $active=$this->DailyCmr_model->getActiveBorrowerbyPro($brcode,$role,$sid,$reportdate,$reportdate,$page);
...
<script>
    ...
    jqOld(function() {
        jqOld("#dateend1" ).datepicker();
    });
    jqOld(function() {
        jqOld("#datestart1" ).datepicker();
    })
...
<script language="javascript" type="text/javascript">
        function printDiv(divID) {
            ...
            window.location.href="<?= site_url("daily/active");?>";
