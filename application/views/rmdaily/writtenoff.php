...
?><!-- page content -->
        ...
        <script src="<?php echo base_url();?>public/vendors/jquery/dist/jquery.min.js"></script>
            ...
            <div class="breadcrumb flat row nopadding" style="margin-top:-10px;">
                        ...
                        <a href="<?= site_url('writtenoffrm');?>" class="active">Written-Off Collection</a>
                           ...
                           <tbody>
                                ...
                                <tr style="text-align:right">
                                    ...
                                    <td><?php 
                                            ...
                                            if($row->ValueWOWithGLDaily==0 || $row->LoanWOBalance==0)
                                            {
                                                echo number_format(0,2);    
                                            }else
                                            {
                                               echo number_format($row->ValueWOWithGLDaily/$row->LoanWOBalance,2);
                                                $totalperWo+=$row->ValueWOWithGLDaily/$row->LoanWOBalance;
                                            } 
                                        
                                     ?></td>
                                    <td><?= number_format($row->Balance,0);?></td>
                                    <td><?= number_format($row->Loan90Collect+$row->ValueWOWithGLDaily,0);$totalCollection+=$row->Loan90Collect+$row->ValueWOWithGLDaily;?></td>
                                    <td><?php
                                            if($row->Collection==0)
                                            {
                                                echo number_format(0,2);
                                    ...
                                    <td><?php if(isset($_GET['keydetail']))
                                        ...
                                        }else{if(isset($_GET['dateend'])){echo date('Y-M-d',strtotime($reportdate));}else{
   ...
   <style>#in{text-align: left;}</style>
    <script language="javascript" type="text/javascript">
        function printDiv(divID) {
            ...
            window.location.href="<?= site_url("writtenoffrm");?>";
