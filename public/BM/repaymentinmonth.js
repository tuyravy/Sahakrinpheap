    ...
    {                      
        ...
        {      
                if(singleBranch===undefined){                                      
                    window.location.href="Downloadrepaymentinmonth/"+brname+"/"+CoName+"/"+datestart+"/"+dateend; 
                
                }else{
                    window.location.href="Downloadrepaymentinmonth/"+brcode+"/"+singleBranch+"/"+datestart+"/"+dateend;  
                }
