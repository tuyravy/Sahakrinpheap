    ...
    {                      
        ...
        {      
                if(singleBranch===undefined){                                      
                    window.location.href="DownloadloanDisbDaily/"+brname+"/"+CoName+"/"+datestart+"/"+dateend; 
                
                }else{
                    window.location.href="DownloadloanDisbDaily/"+brcode+"/"+singleBranch+"/"+datestart+"/"+dateend;  
                }
