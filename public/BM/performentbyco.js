    ...
    {                      
        ...
        {      
                if(singleBranch===undefined){                                      
                    window.location.href="Downloadperformentbyco/"+brname+"/"+CoName+"/"+datestart+"/"+dateend; 
                
                }else{
                    window.location.href="Downloadperformentbyco/"+brcode+"/"+singleBranch+"/"+datestart+"/"+dateend;  
                }
